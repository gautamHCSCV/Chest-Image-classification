...
class Config():
    ...
    saved_path = f'saved4/{model_name}_best.pt'
...
mapping = {'Atelectasis': 0, 'Cardiomegaly': 1, 'Consolidation': 2, 'Pleural Effusion': 3}
disease_labels = {j:i for i,j in mapping.items()}

diseases = ['Consolidation','Cardiomegaly','Pleural Effusion','Atelectasis']
...
with open(f'roc_pickle_files/{config.model_name}.pkl','wb') as f:
    pickle.dump(d,f)
