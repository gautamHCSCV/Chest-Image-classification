...
my_path = '../../../dataset/STANFORD_DATA/stanford_balanced/'
...
pred_effb4_2 = np.array(preds[:,1])
y_test_effb4_2 = np.array(labels)
...
ax1.set_title('BALANCED CHEXPERT')
ax2.set_title('BALANCED VINBIG')

plt.savefig('balanced_ROC.png')
plt.savefig('balanced_ROC.svg',format = 'svg')
plt.show()
