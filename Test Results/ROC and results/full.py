...
pred_mobv2_1 = copy.deepcopy(np.array(preds[:,0]))
y_test_mobv2_1 = 1-np.array(labels)
...
pred_mobv3_1 = copy.deepcopy(np.array(preds[:,0]))
y_test_mobv3_1 = 1-np.array(labels)
...
print(cm.diagonal())
print(roc_auc_score(1-np.array(labels), np.array(preds)[:,0]))
pred_shuff_1 = np.array(preds[:,0])
y_test_shuff_1 = 1-np.array(labels)
...
pred_exlnet_1 = copy.deepcopy(np.array(preds[:,0]))
y_test_exlnet_1 = 1-np.array(labels)
...
pred_res50_1 = copy.deepcopy(np.array(preds[:,0]))
y_test_res50_1 = 1-np.array(labels)
...
y_test_1 = 1-np.array(labels)
pred_squeeze_1 = copy.deepcopy(np.array(preds[:,0]))
...
print(roc_auc_score(1-np.array(labels), np.array(preds)[:,0]))
pred_effb4_2 = np.array(preds[:,0])
y_test_effb4_2 = 1-np.array(labels)
...
pred_mobv2_2 = copy.deepcopy(np.array(preds[:,0]))
y_test_mobv2_2 = 1-np.array(labels)
...
pred_mobv3_2 = copy.deepcopy(np.array(preds[:,0]))
y_test_mobv3_2 = 1-np.array(labels)
...
print(cm.diagonal())
print(roc_auc_score(1-np.array(labels), np.array(preds)[:,0]))
pred_shuff_2 = np.array(preds[:,0])
y_test_shuff_2 = 1-np.array(labels)
...
pred_exlnet_2 = copy.deepcopy(np.array(preds[:,0]))
y_test_exlnet_2 = 1-np.array(labels)
...
pred_res50_2 = copy.deepcopy(np.array(preds[:,0]))
y_test_res50_2 = 1-np.array(labels)
...
y_test_2 = 1-np.array(labels)
pred_squeeze_2 = copy.deepcopy(np.array(preds[:,0]))
...
fpr, tpr, threshold = metrics.roc_curve(y_test_effb4_1, pred_effb4_1)
roc_auc = metrics.auc(fpr, tpr)
ax1.plot(fpr, tpr, 'b', label = 'Efficientnet-B4: %0.2f' % roc_auc,color = 'red')
...
fpr, tpr, threshold = metrics.roc_curve(y_test_effb4_2, pred_effb4_2)
roc_auc = metrics.auc(fpr, tpr)
ax2.plot(fpr, tpr, 'b', label = 'Efficientnet-B4: %0.2f' % roc_auc,color = 'red')
...
ax1.set_title('ROC CURVE USING CHEXPERT')
ax2.set_title('ROC CURVE USING VINBIG')
