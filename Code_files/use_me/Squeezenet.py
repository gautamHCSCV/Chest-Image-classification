...
print(device)
config = dict(
    saved_path="saved/exlnet01.pt",
    best_saved_path = "saved/exlnet01_best.pt",
    lr=0.001, 
    EPOCHS = 40,
    BATCH_SIZE = 32,
    IMAGE_SIZE = 224,
...
print(len(images))
train_data,valid_data,test_data = torch.utils.data.dataset.random_split(images,[100000,5000,7120])
