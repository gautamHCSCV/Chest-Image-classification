...
print(device)
config = dict(
    saved_path="saved15/exlnet4.pt",
    best_saved_path = "saved15/exlnet4_best.pt",
    lr=0.0001, 
    EPOCHS = 35,
    BATCH_SIZE = 32,
    IMAGE_SIZE = 224,
...
print(len(images))
train_data,valid_data,test_data = torch.utils.data.dataset.random_split(images,[120000,10000,11537])
...
model = squeezenet
model.load_state_dict(torch.load('saved15/exlnet3.pt'))
print(model)
