...
try:
    torch.save({'model':squeezenet.state_dict(),'message':message},'saved_models/merged_nih_smoothlrc.pth')
    print('saved')
except Exception as e:
    print(e)
    
model.save_model('saved_models/merged_nih_smoothlrc_best_model.pth', message)
