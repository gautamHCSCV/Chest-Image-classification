...
schedular = optim.lr_scheduler.StepLR(optimizer,step_size=41,gamma=0.1)
n_epochs=80
...
try:
    torch.save({'model':squeezenet.state_dict(),'message':message},'saved_models/merged_cifar100_2.pth')
    print('saved')
except Exception as e:
    print(e)


model.save_model('saved_models/merged_cifar100_best_2.pth',message)