...
print(device)
config = dict(
    saved_path="saved/exlbn2.pt",
    best_saved_path = "saved/exlbn2_best.pt",
    lr=0.0003, 
    EPOCHS = 25,
    BATCH_SIZE = 32,
    IMAGE_SIZE = 224,
...
print(len(images))
train_data,valid_data,test_data = torch.utils.data.dataset.random_split(images,[100000,7000,5120])
