...
class Model_class(object):
    ...
    def train(self,train_loader,optimizer,Losses_,lr,n_epochs,validate_loader,schedular,divide=True,regularization = 'None'):
        weight_decay = 0.0001
...
#         data = data/255
    ...
    def evaluate(self,loader,divide=True,name='test'):
